...
class OrderServiceTest {
    ...
    void findByCustomerId_顧客IDで注文一覧が返ること() {
        ...
        Order order = new Order(
                "ORD-006", "C005", "中村 四郎", items,
                "発送済", "2026-05-15", "福岡県福岡市", ""
        );

        when(repository.findByCustomerId("C005"))
